...
#ifndef AVALON_SIMULATION_MICROPHONES_TASK_HPP
#define AVALON_SIMULATION_MICROPHONES_TASK_HPP
...
namespace avalon_simulation {
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','avalon_simulation::Microphones')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument. 
     */
    class Microphones : public MicrophonesBase
    {
